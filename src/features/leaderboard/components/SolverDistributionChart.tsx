  ...
  return (
    <div className="solver-distribution">
      ...
      <div className="distribution-legend">
        <div className="legend-item" data-tooltip="Solvers who completed exactly 1 puzzle">
          <span className="legend-color one-puzzle"></span>
          <span className="legend-text">One-Timers</span>
        </div>
        <div className="legend-item" data-tooltip="Solvers who completed 2–9 puzzles">
          <span className="legend-color two-nine"></span>
          <span className="legend-text">Enthusiasts</span>
        </div>
        <div className="legend-item" data-tooltip="Solvers who completed 10 or more puzzles">
